...
class ProductPage {
    ...
    saveProductData(index) {
        ...
        this.elements.productsNameLabel().invoke('text').then(name => {
            product.name = name.trim();
        });

        this.elements.productsDescriptionLabel().invoke('text').then(description => {
            product.description = description.trim();
        });

        this.elements.productsPriceLabel().invoke('text').then(price => {
